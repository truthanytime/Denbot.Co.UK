...
link.href = 'http://localhost:3000/bot.css';
link.rel = 'stylesheet';
...
link.onload = function () {
  ...
  window.onload = function () {
    ...
    <iframe
      ...
      src="http://localhost:3000/preview/${botIdValue}?color=${button_color.substring(1)}&isTransparent=${isTransparent}"
  ...
  <span
   ...
   <svg
    ...
    function sendBotStartMessage() {
      ...
      iframe_element.contentWindow.postMessage({ action: 'startBotMessage' }, `http://localhost:3000/preview/${botIdValue}?color=${button_color.substring(1)}`);
    }
